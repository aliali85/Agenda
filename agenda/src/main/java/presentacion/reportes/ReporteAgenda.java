...
public class ReporteAgenda {
	...
	private List<PersonaReporte> obtenerListadoPersonasReporte(List<PersonaDTO> personasDTO)
	{
		...
		{
			PersonaReporte persona = new PersonaReporte(personaDTO.getNombre(), personaDTO.getTelefono(), personaDTO.getEmail(), personaDTO.getFechaNacimiento(), personaDTO.getCalle(), personaDTO.getAltura(), personaDTO.getPiso(), personaDTO.getDepartamento(), personaDTO.getLocalidad(), null);
